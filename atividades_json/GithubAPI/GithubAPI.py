...
def main():
    ...
    for follower in followers:
        ...
        url_seguidor = urlUsuario.format(seguidor)

        print url_seguidor

        retorno_seguidor = urllib2.urlopen(url_seguidor).read()

        dados_seguidor = json.loads(retorno_seguidor)

        nomeSeguidor = dados_seguidor['name']
